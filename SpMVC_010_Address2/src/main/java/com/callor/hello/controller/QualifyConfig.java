...
public class QualifyConfig {
	...
	public final static String ADDRESS_SERVCE_V1 = "addressServiceV1";
	public final static String ADDRESS_SERVCE_V2 = "addressServiceV2";
	public final static String ADDRESS_SERVCE_V3 = "addressServiceV3";
}
