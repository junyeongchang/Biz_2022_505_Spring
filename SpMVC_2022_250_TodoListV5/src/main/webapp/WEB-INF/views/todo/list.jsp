	...
	<sec:authorize access="isAuthenticated()">
		...
		<c:forEach items="${TODOS}" var="TODO">
			<div data-seq="${TODO.t_seq}"
				...
				>
				${TODO.t_content} <span class="w3-text todo_content" > (시작 : ${TODO.t_sdate} ${TODO.t_stime}) </span>
		...
		<form:form>
			<input name="t_content" value="${TODO.t_content}"
				placeholder="TODO Insert" class="w3-input w3-border" />
		</form:form>
	</sec:authorize>
</div>