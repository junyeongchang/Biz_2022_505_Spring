...
<body>
	<section class="w3-container">
		<div class="w3-container detail-flex">
			...
			<div class="detail">
				<h2>
					도서명 : <a href="${BOOK.link}" target=_NEW>${BOOK.title}></a>
				</h2>
				<p>ISBN : ${BOOK.isbn}
				<p>저자 : ${BOOK.author}
		...
		<div>
			<div class="btn-box">
				...
				<%
				// href="javascript:void(0)" : a tag 의 link 연결기능을 완전 무력화하기
				%>
...
<script>
	...
	.href 는 브라우져 화면이 전환될때 history를 계속 간직하고 있다.
	어떤 page에서 계속 뒤로가기를 클릭하면 연속으로 뒤로 복귀가 된다.
	
	.replace()는 현재화면의 history를 제거해 버리고 새로운 page로 
	덮어쓰기가 된다.
	뒤로가기를 눌렀을때 현재 보고있는 page를 열수 없다는 것이다.
