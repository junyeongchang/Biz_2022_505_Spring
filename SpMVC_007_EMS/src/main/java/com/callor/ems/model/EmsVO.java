...
public class EmsVO {
	...
	@NotEmpty(message = "받는사람 Email을 반드시 입력하세요!!")
	private String e_to_email;

	@Length(min = 1, max = 100, message = "받는 사람 이름은 1글자~100글자 까지만 가능")
	...
	//@Size(min = 1, max = 10, message = "num 는 1부터 10사이의 값이어야 합니다.")
	private String e_sendDate;
	private String e_send_time;

	//@Min(value = 1, message = "num 는 1보다 커야 합니다.")
